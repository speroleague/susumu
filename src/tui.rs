...
use crate::{
    model::{
        ...
        FlowEdge, Language, Location, ProjectAnalysis, ReviewThread, Severity, SourceFile,
        Verification, VerificationStatus, Work, WorkStatus, Workflow,
    },
    susu::write_susu,
};
...
impl App {
    ...
    fn item_count(&self) -> usize {
        match self.tab {
            ...
            10 => self.analysis.review_threads.len(),
            11 => self.analysis.files.len(),
            _ => 1,
        }
    }
...
fn render_content(frame: &mut Frame<'_>, app: &mut App, area: Rect) {
    match app.tab {
        ...
        3..=6 | 10 => render_record_content(frame, app, area),
        7..=9 | 11 => render_evidence_content(frame, app, area),
        _ => {}
    }
}
...
fn render_record_content(frame: &mut Frame<'_>, app: &mut App, area: Rect) {
    match app.tab {
        ...
        10 => render_review_threads(frame, app, area),
        _ => {}
    }
}
...
mod tests {
    ...
    use super::*;
    use crate::model::{ReviewCommentKind, ReviewStatus, SCHEMA_VERSION, WorkKind};
    ...
    #[test]
    fn review_threads_tab_renders_authored_ownership_context() {
        let analysis = ProjectAnalysis {
            schema_version: SCHEMA_VERSION,
            project_name: "reviews".to_owned(),
            root: ".".to_owned(),
            generated_unix_seconds: 0,
            source_revision: None,
            files: Vec::new(),
